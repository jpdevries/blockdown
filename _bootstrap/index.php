...
if (!createObject('modNamespace',array(
    'name' => 'blockdown',
    'path' => $componentPath.'/core/components/blockdown/',
    'assets_path' => $componentPath.'/assets/components/blockdown/',
),'name', false)) {
    echo "Error creating namespace blockdown.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'blockdown.core_path',
    'value' => $componentPath.'/core/components/blockdown/',
    'xtype' => 'textfield',
    'namespace' => 'blockdown',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating blockdown.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'blockdown.assets_path',
    'value' => $componentPath.'/assets/components/blockdown/',
    'xtype' => 'textfield',
    'namespace' => 'blockdown',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating blockdown.assets_path setting.\n";
}
...
$assetsUrl = "{$url}{$requestUri}assets/components/blockdown/";

if (!createObject('modSystemSetting', array(
    'key' => 'blockdown.assets_url',
    'value' => '[[++assets_url]]components/blockdown/',
    'xtype' => 'textfield',
    'namespace' => 'blockdown',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating blockdown.assets_url setting.\n";
}

if (!createObject('modPlugin', array(
    'name' => 'blockdown',
    'static' => true,
    'static_file' => $componentPath.'/core/components/blockdown/elements/plugins/blockdown.plugin.php',
), 'name', true)) {
    echo "Error creating blockdown Plugin.\n";
}
$plugin = $modx->getObject('modPlugin', array('name' => 'blockdown'));
if ($plugin) {
...
foreach ($settings as $key => $opts) {
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating blockdown.".$key." setting.\n";
    }
}
